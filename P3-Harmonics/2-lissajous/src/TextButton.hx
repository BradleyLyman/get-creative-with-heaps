...
class TextButton extends Object {
  ...
  **/
  public function new(parent: Object, ?color: Color, ?font: Font) {
    ...
    this.interactive.onOut            = (_) -> {this.overlay.visible = false;};
    this.interactive.onPush           = (_) -> {this.overlay.visible = false;};
    this.interactive.onReleaseOutside = (_) -> {this.overlay.visible = false;};
    this.interactive.onOver    = (_) -> {this.overlay.visible = true;};
    this.interactive.onRelease = (_) -> {this.overlay.visible = true;};
  }
  ...
  private function get_text() : String { return visual.text; }
  private function get_width() : Float { return this.width; }
  private function get_height() : Float { return this.height; }
