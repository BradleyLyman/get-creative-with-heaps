...
abstract Vector(Array<Float>) from Array<Float> to Array<Float> {
  ...
  public inline function set_x(val: Float) : Float {this[0] = val; return val;}

  public inline function get_y() : Float {return this[1];}
  public inline function set_y(val: Float) : Float {this[1] = val; return val;}

  public inline function get_z() : Float {return this[2];}
  public inline function set_z(val: Float) : Float {this[2] = val; return val;}
}